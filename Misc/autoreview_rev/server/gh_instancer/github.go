...
func newInstance(user *user, teamToken string) (*string, error) {
	targetRepoName := "revenge-auto-review-" + user.Login
	...
	_, _, err = client.Repositories.CreateFromTemplate(context.Background(), orgName, "revenge-auto-review", &github.TemplateRepoRequest{
